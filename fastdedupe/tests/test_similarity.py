...
class TestSimilarityAlgorithms(unittest.TestCase):
    ...
    def test_levenshtein_similarity(self) -> None:
        ...
        self.assertEqual(levenshtein_similarity("APPLE", "apple", processor=str.lower), 100)
    ...
    def test_jaro_winkler_similarity(self) -> None:
        ...
        # Test with processor argument
        self.assertEqual(jaro_winkler_similarity("JOHN", "john", processor=str.lower), 100)
    ...
    def test_cosine_ngram_similarity(self) -> None:
        ...
        # Test with processor argument
        self.assertEqual(cosine_ngram_similarity("DOCUMENT", "document", processor=str.lower), 100)
    ...
    def test_get_similarity_function(self) -> None:
        ...
        self.assertEqual(get_similarity_function(SimilarityAlgorithm.LEVENSHTEIN), levenshtein_similarity)
        self.assertEqual(get_similarity_function(SimilarityAlgorithm.JARO_WINKLER), jaro_winkler_similarity)
        self.assertEqual(get_similarity_function(SimilarityAlgorithm.COSINE), cosine_ngram_similarity)
        self.assertEqual(get_similarity_function(SimilarityAlgorithm.JACCARD), jaccard_similarity)
        self.assertEqual(get_similarity_function(SimilarityAlgorithm.SOUNDEX), soundex_similarity)
        
        # Test with string values
        self.assertEqual(get_similarity_function("levenshtein"), levenshtein_similarity)
        self.assertEqual(get_similarity_function("jaro_winkler"), jaro_winkler_similarity)
...
class TestVisualization(unittest.TestCase):
    ...
    def test_visualize_similarity_matrix(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            fig = visualize_similarity_matrix(strings, SimilarityAlgorithm.LEVENSHTEIN, output_file)
